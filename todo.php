...
<body style="background-color: white">
    ...
    <div class="header-list">
        ...
        <div class="desc">
            <p>"Task Mastery Simplified: Elevate Your <br>
Productivity with ToWin!"
</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="card" style="background-color: white; border: 2px solid #FAC372; ">
            <div class="task-item <?= $r['task_status'] == 'close' ? 'done' :''?>">
                ...
                <div>
                <a href="edit.php?id=<?=$r['task_id']?>" class="edit-task" title="edit"><i class='bx bx-edit-alt' ></i>
                <a href="?delete=<?= $r['task_id']?>" class="delete-task" title="remove" onclick="return confirm('Are you sure?')"><i class='bx bx-trash-alt' ></i></a>
                </div>
            </div>
        </div>
